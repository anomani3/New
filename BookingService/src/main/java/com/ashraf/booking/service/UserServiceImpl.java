package com.ashraf.booking.service;
...
import com.ashraf.booking.entity.DatabaseSequence;
import com.ashraf.booking.entity.UserDetails;
import com.ashraf.booking.exception.ResourceNotFoundException;
import com.ashraf.booking.repository.UserRepository;
...
public class UserServiceImpl implements UserService 
{
	...
	public String deleteUserBookingDetails(long pnrNo) {
		...
		try { sendEmail(pnrNo); } catch (AddressException e) { 
			  e.printStackTrace(); }
		return msg;
		}
	...
	.subject("Your Flight is booked").body(data1 + "\n" + data2 + "\n" + userDet).encoding("UTF-8").build();
