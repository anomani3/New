...
public class UserServiceImpl implements UserService 
{
	...
	public static int getNextSequence(String key)  {
	  ...
	  return !Objects.isNull(dbSeq) ? dbSeq.getSeq() : 1;
		...
		/*
		 * //to send an email after booking of a train ticket public void sendEmail(long
		 * pnrNo) throws AddressException{ String
		 * data1="Your train ticket booking is successful..!!"; String data2=
		 * "Please Check the details....!!!!!!"; UserDetails
		 * userDet=getUserDetailsById(pnrNo); final Email email = DefaultEmail.builder()
		 * .from(new InternetAddress("surajthopate24@gmail.com")) .replyTo(new
		 * InternetAddress("surajthopate24@gmail.com")) .to(Lists.newArrayList(new
		 * InternetAddress("surajthopate24@gmail.com")))
		 * .subject("Your ticket is booked") .body(data1+ "\n"+data2+"\n"+userDet)
		 * .encoding("UTF-8") .build(); emailService.send(email); }
		 */
	
		/*
		 * //For email notification after Cancelled payment public void sendEmails(long
		 * pnrNo) throws AddressException{ final Email email = DefaultEmail.builder()
		 * .from(new InternetAddress("surajthopate24@gmail.com")) .replyTo(new
		 * InternetAddress("surajthopate24@gmail.com")) .to(Lists.newArrayList(new
		 * InternetAddress("surajthopate24@gmail.com")))
